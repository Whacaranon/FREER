...
spawn(function()
    ...
    Main:AddToggle("Auto Quest Elite [Combo]",nil,function(a)
    _G.kill = a
    end)
    ...
    Main:AddToggle("Kill Elite [Combo]",nil,function(a)
    _G.combo = a
    StopTween(_G.combo)
    end)
